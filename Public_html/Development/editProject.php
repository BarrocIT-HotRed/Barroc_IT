...
<div class="content">
    ...
    <div class="form">
        <form action="" method="post">
            ...
            <div class="form-group">
                <label for="open-projects">Open Projects</label>
                <input type="text" name="OpProjects" id="open-projects">
            </div>
        
            <div class="form-group">
                <label for="applications">Applications</label>
                <input type="text" name="App" id="applications">
            </div>
    ...
    <div class="btn">
        <button><a href="development-website.php">Publish</a></button>
    </div>
